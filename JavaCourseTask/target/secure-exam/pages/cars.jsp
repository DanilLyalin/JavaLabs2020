...
<div class="container">
    ...
    <div class="jumbotron" style="margin-top: 20px;">
        ...
        <sec:authorize access="isAuthenticated()">
            ...
            <h3>Таблица автомобилей автопарка</h3>
                    ...
                    fetch('/secure/cars/get/all', {
                        ...
                        .then(function (tableInitData) {
                            ...
                            for (let i = 0; i < tableInitData.length; i++) {
                                ...
                                td2.appendChild(document.createTextNode(tableInitData[i].num))
                                let td3 = document.createElement("TD")
                                td3.appendChild(document.createTextNode(tableInitData[i].mark))
                                let td4 = document.createElement("TD")
                                td4.appendChild(document.createTextNode(tableInitData[i].color))
                                row.appendChild(td1);
                                row.appendChild(td2);
                                row.appendChild(td3);
                                row.appendChild(td4);
